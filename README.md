...
Consider this repostory as an experimental resource only.
...
Although that forum thread has not shown recent activity.

The documentation here reflects **my own experimentation and testing** on the Huawei Matebook 14s, with the goal of recording possible improvements and sharing results.

## Current Status
- [x] macOS installation from USB  
- [x] OpenCore boot from USB  
- [x] Boot from internal disk  
- [ ] Intel Iris Xe acceleration (unsupported, experimental)  
- [x] Touchpad functional with VoodooI2C (patched Info.plist)  
- [ ] Audio configuration (Recognized but not working)  
